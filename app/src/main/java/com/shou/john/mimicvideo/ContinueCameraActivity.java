...
import com.shou.john.mimicvideo.view.RecordedButton;
import com.shou.john.mimicvideo.view.videoRecorder.client.RecorderClient;
import com.shou.john.mimicvideo.view.videoRecorder.core.listener.IVideoChange;
import com.shou.john.mimicvideo.view.videoRecorder.filter.softaudiofilter.SetVolumeAudioFilter;
...
import com.shou.john.mimicvideo.view.videoRecorder.tools.TimeHandler;
import com.shou.john.mimicvideo.view.videoRecorder.tools.VideoSplicer;
import com.shou.john.mimicvideo.view.videoRecorder.ui.AspectTextureView;
...
public class ContinueCameraActivity extends BaseActivity implements
    ...
    private static Rect getScreenBounds(Context context) {
        ...
        ((WindowManager) context
                .getSystemService(WINDOW_SERVICE)).getDefaultDisplay().getMetrics(displayMetrics);
