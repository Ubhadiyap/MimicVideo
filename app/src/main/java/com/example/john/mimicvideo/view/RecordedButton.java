package com.example.john.mimicvideo.view;
...
public class RecordedButton extends View {
    ...
    private void init() {
        ...
        dp5 = (int) getResources().getDimension(com.zhaoshuang.weixinrecorded.R.dimen.dp6);
        colorGray = getResources().getColor(com.zhaoshuang.weixinrecorded.R.color.video_gray);
        colorBlue = getResources().getColor(com.zhaoshuang.weixinrecorded.R.color.videoRecordProgress);
